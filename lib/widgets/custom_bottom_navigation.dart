...
class CustomBottomNavigation extends StatelessWidget {
  ...
  // Ícones todos em contorno (outline) + caixinha premium no FAB
  static const Map<int, IconData> _icons = {
    0: Icons.home_outlined,
    1: Icons.grid_view_outlined,
    2: Icons.assignment_turned_in_outlined, // Pedidos
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 70), // espaço pro botão central
          ...
          // CAIXINHA PREMIUM (agora é o centro do app!)
          Positioned(
            bottom: 16,
  ...
  Widget _buildNavItem({
    ...
    final Color color = isActive ? const Color(0xFFFA4815) : Colors.grey.shade500;
